"""
Django settings for Upgrade_Lab project.
...
SECRET_KEY = 'django-insecure-$#vxxrwk(oqf(cfmp_@y*c+6g1nz-72&5bb)jd9zv%j%66rh(3'
...
WSGI_APPLICATION = 'Upgrade_Lab.wsgi.application'
